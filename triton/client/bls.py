...
if __name__ == "__main__":
    ...
    # Готовим массивы на вход в модель.
    # У нашей модели "rubert" есть один вход - INPUT
    ...
    try:
        resp = triton_client.infer("rubert_bls", inputs, request_id=str(uuid4()))
    except InferenceServerException as ex:
        print(ex)
    else:
        print("----- OUTPUT -----")
        result = resp.as_numpy("OUTPUT").astype("U13")
