...
class TritonPythonModel:
    ...
    def initialize(self, args: Dict[str, str]):
        ...
        self.config = AutoConfig.from_pretrained(f"{args['model_repository']}/{args['model_version']}")
        print('Initialized...')
    ...
    def execute(self, requests):
        ...
        for request in requests:
            ...
            response_class = [[self.config.id2label[cls_id].encode("UTF-8")] for cls_id in class_ids]
